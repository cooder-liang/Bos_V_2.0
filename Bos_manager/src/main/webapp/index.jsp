...
<head>
    ...
    <script type="text/javascript">
        ...
        /*关于我们*/
        function showAbout() {
            $.messager.alert("bos v2.0综合物流管理平台", "设计: honor<br/> 管理员邮箱: m18513333561@163.com <br/>")
        }

        /*退出*/
        function logoutFun() {
            $.messager.confirm("系统提示", "您确定退出本次登录", function (isLogin) {
                if (isLogin) {
        ...
        <tr>
            <td style="width: 400px;">
                <div style="color: #999; font-size: 8pt;">
                    BOSv2.0综合物流管理平台 | Powered by <a href="#">honor</a>
                </div>
            </td>
            <td class="co1"><span id="online" style="background: url(images/online.png)
            no-repeat left;padding-left:18px;margin-left:3px;font-size:8pt;color:#005590;">在线人数:1</span>
            </td>
        </tr>
        </tbody>
    </table>
...
<div data-options="region:'center',title:'Center'">
    <div id="tabs" fit="true" class="easyui-tabs" border="false">
        <div title="消息中心" id="subWarp" style="width:100%;height:100%;overflow:hidden">
            <iframe src="./pages/home.html" style="width:100%;height:100%;border:0;"></iframe>
        </div>
    </div>
</div>
